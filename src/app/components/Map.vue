<template>
  <div class="map">
    ...
    <button class="map__togglemain" aria-expanded="true" aria-controls="main-content" @click="toggleDesktopMain">
...
const MapGeoLocation = () =>
    import(/* webpackChunkName: 'map' */ "./MapGeoLocation.vue");
const MapDirections = () =>
    import(/* webpackChunkName: 'map' */ "./MapDirections.vue");
